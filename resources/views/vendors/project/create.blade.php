...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select name="agent" class="form-control js-example-basic-single3">
    ...
    <div class="modal" id="exitModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>{{ __("Are you sure you want to leave? Your changes may not be saved.") }}</p>
                </div>
                <div class="modal-footer">
                    <button type="button" id="confirmExit" class="btn btn-primary" data-dismiss="modal">{{ __('Leave') }}</button>
                    <button type="button" id="cancelExit" class="btn btn-secondary" data-dismiss="modal">{{ __("Stay") }}</button>
                </div>
            </div>
        </div>
    </div>
