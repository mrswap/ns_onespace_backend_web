    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item @if (request()->routeIs('admin.property_specification.categories')) active 
              ...
              @elseif(request()->routeIs('admin.property_specification.cities'))  show @endif">
                        <ul class="nav nav-collapse">
                            <li class="{{ request()->routeIs('admin.property_specification.settings') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.settings') }}">
                                    <span class="sub-item">{{ __('Settings') }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.property_specification.types') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.types', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">{{ __('Types') }}</span>
                                </a>
                            </li>


                            <li class="{{ request()->routeIs('admin.property_specification.amenities') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.amenities', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">{{ __('Facilities') }}</span>
                                </a>
                            </li>
                            @if ($settings->property_country_status == 1)
                            <li class="{{ request()->routeIs('admin.property_specification.countries') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.countries', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">{{ __('Countries') }}</span>
                                </a>
                            </li>
                            @endif
                            @if ($settings->property_state_status == 1)
                            <li class="{{ request()->routeIs('admin.property_specification.states') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.states', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">{{ __('States') }}</span>
                                </a>
                            </li>
                            @endif
                            <li class="{{ request()->routeIs('admin.property_specification.cities') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_specification.cities', ['language' => $defaultLang->code]) }}">
                                    <span class="sub-item">{{ __('Cities') }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.category_management.index') ? 'active' : '' }}">
                                <a href="{{ route('admin.category_management.index') }}">
                                    <span class="sub-item">{{ __('Assets Categories') }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.subcategory_management.index') ? 'active' : '' }}">
                                <a href="{{ route('admin.subcategory_management.index') }}">
                                    <span class="sub-item">{{ __('Assets Sub Categories') }}</span>
                                </a>
                            </li>
              ...
              ">
                        <ul class="nav nav-collapse">
                            <li class="{{ request()->routeIs('admin.property_management.settings') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_management.settings') }}">
                                    <span class="sub-item">{{ __('Settings') }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.property_management.create_property') || request()->routeIs('admin.property_management.type') ? 'active' : '' }}">
                                <a href="{{ route('admin.property_management.type') }}">
                                    <span class="sub-item">{{ __('Add Property') }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.property_management.properties') ||
                                    request()->routeIs('admin.property_management.edit')
                                        ? 'active'
                                        : '' }}">
                                <a href="{{ route('admin.property_management.properties', ['language' => $defaultLang->code]) }}">
                ...
                <li class="nav-item @if (request()->routeIs('admin.featured_pricing.index')) active @elseif(request()->routeIs('admin.featured_pricing.edit')) active @elseif(request()->routeIs('admin.requested_for_featured')) active @endif">
              ...
              @if (request()->routeIs('admin.featured_pricing.index')) show @elseif(request()->routeIs('admin.featured_pricing.edit')) show @elseif(request()->routeIs('admin.requested_for_featured')) show @endif">
                        <ul class="nav nav-collapse">
                            ...
                            <li class="{{ request()->routeIs('admin.featured_pricing.index') || request()->routeIs('admin.featured_pricing.edit') ? 'active' : '' }}">
                                <a href="{{ route('admin.featured_pricing.index') }}">
                                    <span class="sub-item">{{ 'Pricing' }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.requested_for_featured') && request()->input('status') == 'all' ? 'active' : '' }}">
                                <a href="{{ route('admin.requested_for_featured', ['status' => 'all']) }}">
                                    <span class="sub-item">{{ 'All Request' }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.requested_for_featured') && request()->input('status') == 'pending' ? 'active' : '' }}">
                                <a href="{{ route('admin.requested_for_featured', ['status' => 'pending']) }}">
                                    <span class="sub-item">{{ 'Pending Request' }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.requested_for_featured') && request()->input('status') == 'accepted' ? 'active' : '' }}">
                                <a href="{{ route('admin.requested_for_featured', ['status' => 'accepted']) }}">
                                    <span class="sub-item">{{ 'Accepted Request' }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.requested_for_featured') && request()->input('status') == 'rejected' ? 'active' : '' }}">
              ...
              ">
                        <ul class="nav nav-collapse">
                            ...
                            <li class="{{ request()->routeIs('admin.project_management.settings') ? 'active' : '' }}">
                                <a href="{{ route('admin.project_management.settings') }}">
                                    <span class="sub-item">{{ __('Settings') }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.project_management.create_project') ? 'active' : '' }}">
                                <a href="{{ route('admin.project_management.create_project') }}">
                                    <span class="sub-item">{{ __('Add Project') }}</span>
                                </a>
                            </li>

                            <li class="{{ request()->routeIs('admin.project_management.projects') ||
                                    request()->routeIs('admin.property_management.edit') ||
                                    request()->routeIs('admin.project_management.project_types')
                                        ? 'active'
                                        : '' }}">
                                <a href="{{ route('admin.project_management.projects', ['language' => $defaultLang->code]) }}">
                ...
                {{-- end Category  --}}
                {{-- Start Category  --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Property Enquiry', $rolePermissions)))
                <li class="nav-item  @if (request()->routeIs('admin.PropertyEnquiry_management.index')) active @endif">
                    <a href="{{ route('admin.PropertyEnquiry_management.index') }}">
                        <i class="fal fa-users-cog"></i>
                        <p> {{ 'Property Enquiry management' }} </p>
                    </a>
                </li>
                @endif
                {{-- end Category  --}}
                {{-- Start Category  --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Property Enquiry', $rolePermissions)))
                <li class="nav-item  @if (request()->routeIs('admin.PropertyImpresion_management.index')) active @endif">
                    <a href="{{ route('admin.PropertyImpresion_management.index') }}">
                        <i class="fal fa-users-cog"></i>
                        <p> {{ 'Property Impresion management' }} </p>
                    </a>
                </li>
                @endif
                {{-- end Category  --}}
            ...
            @elseif (request()->routeIs('admin.package.edit')) active @endif">
              ...
              @elseif (request()->routeIs('admin.package.edit')) show @endif">
                ...
                {{-- Start Category  --}}
                @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('ContactUs', $rolePermissions)))
                <li class="nav-item  @if (request()->routeIs('admin.ContactUs_management.index')) active @endif">
                    <a href="{{ route('admin.ContactUs_management.index') }}">
                        <i class="fal fa-users-cog"></i>
...
active @endif
              ...
              @elseif (request()->routeIs('admin.vendor_management.vendor.change_password')) show @endif">
                  ...
                  @elseif (request()->routeIs('admin.vendor_management.vendor.change_password')) active @endif">
                                <a href="{{ route('admin.vendor_management.registered_vendor') }}">
                                    <span class="sub-item">{{ 'Registered Owner' }}</span>
                                </a>
                            </li>
            ...
            @elseif (request()->routeIs('admin.support_tickets.message')) active active @endif">
              ...
              @elseif (request()->routeIs('admin.support_tickets.message')) show @endif">
                        <ul class="nav nav-collapse">
                            ...
                            <li class="{{ request()->routeIs('admin.support_tickets') && empty(request()->input('status')) ? 'active' : '' }}">
                                <a href="{{ route('admin.support_tickets') }}">
                                    <span class="sub-item">{{ 'All Tickets' }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.support_tickets') && request()->input('status') == 1 ? 'active' : '' }}">
                                <a href="{{ route('admin.support_tickets', ['status' => 1]) }}">
                                    <span class="sub-item">{{ 'Pending Tickets' }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.support_tickets') && request()->input('status') == 2 ? 'active' : '' }}">
                                <a href="{{ route('admin.support_tickets', ['status' => 2]) }}">
                                    <span class="sub-item">{{ 'Open Tickets' }}</span>
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('admin.support_tickets') && request()->input('status') == 3 ? 'active' : '' }}">
                ...
                <li class="nav-item @if (request()->routeIs('admin.home_page.hero_section.slider_version')) active 
              ...
              @elseif (request()->routeIs('admin.home_page.partners')) show @endif">
                    ...
                    @if (request()->routeIs('admin.home_page.hero_section.slider_version')) show             @elseif (request()->routeIs('admin.home_page.hero_section.static_version')) show @endif">
                                    <ul class="nav nav-collapse subnav">
                                        ...
                                        <li class="{{ request()->routeIs('admin.home_page.hero_section.slider_version') ? 'active' : '' }}">
                                            <a href="{{ route('admin.home_page.hero_section.slider_version', ['language' => $defaultLang->code]) }}">
                                                <span class="sub-item">{{ 'Slider Version' }}</span>
                                            </a>
                                        </li>
                                        @else
                                        <li class="{{ request()->routeIs('admin.home_page.hero_section.static_version') ? 'active' : '' }}">
                            ...
                            @endif
                            @if ($settings->theme_version == 1 || $settings->theme_version == 3 || $settings->theme_version == 5)
                            ...
                            <li class="{{ request()->routeIs('admin.home_page.why_choose_us_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.why_choose_us_section', ['language' => $defaultLang->code]) }}">
                            ...
                            <li class="{{ request()->routeIs('admin.home_page.property_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.property_section', ['language' => $defaultLang->code]) }}">
                            ...
                            <li class="{{ request()->routeIs('admin.home_page.project_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.project_section', ['language' => $defaultLang->code]) }}">
                                ...
                                @if ($settings->theme_version == 2)
                            <li class="{{ request()->routeIs('admin.home_page.pricing_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.pricing_section', ['language' => $defaultLang->code]) }}">
                            ...
                            @if ($settings->theme_version == 1)
                            <li class="{{ request()->routeIs('admin.home_page.city_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.city_section', ['language' => $defaultLang->code]) }}">
                            ...
                            <li class="{{ request()->routeIs('admin.home_page.call_to_action_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.call_to_action_section', ['language' => $defaultLang->code]) }}">
                            ...
                            @if ($settings->theme_version == 1)
                            <li class="{{ request()->routeIs('admin.home_page.vendor_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.vendor_section', ['language' => $defaultLang->code]) }}">
                            ...
                            @if ($settings->theme_version == 1)
                            <li class="{{ request()->routeIs('admin.home_page.subscribe_section') ? 'active' : '' }}">
                                <a href="{{ route('admin.home_page.subscribe_section', ['language' => $defaultLang->code]) }}">
                ...
                <li class="nav-item @if (request()->routeIs('admin.footer.logo_and_image')) active 
            ...
            @elseif (request()->routeIs('admin.footer.quick_links')) active @endif">
                    ...
                    <div id="footer" class="collapse @if (request()->routeIs('admin.footer.logo_and_image')) show 
              ...
              @elseif (request()->routeIs('admin.basic_settings.social_medias')) show @endif">
                    ...
                    @elseif (request()->routeIs('admin.basic_settings.edit_mail_template')) show @endif">
                        ...
                        @elseif (request()->routeIs('admin.basic_settings.edit_mail_template')) active @endif">
                            ...
                            <li class="{{ request()->routeIs('admin.basic_settings.insta.links.index') ? 'active' : '' }}">
                                <a href="{{ route('admin.basic_settings.insta.links.index') }}">
                                    <span class="sub-item">{{ 'Instagram Post Links' }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
