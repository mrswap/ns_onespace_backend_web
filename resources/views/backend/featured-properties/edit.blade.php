                        ...
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm" class="" action="{{ route('admin.featured_pricing.update') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="for" class="form-control ltr" name="for">
                                        <option value="" selected disabled>{{ __('Select a type') }}</option>
                                        <option value="tenant" {{ $pricing->for == 'tenant' ? 'selected' : '' }}>{{ __('Tenant') }}</option>
                                        <option value="owner" {{ $pricing->for == 'owner' ? 'selected' : '' }}>{{ __('Owner') }}</option>
                                        <option value="buyer" {{ $pricing->for == 'buyer' ? 'selected' : '' }}>{{ __('Buyer') }}</option>
                                        <option value="seller" {{ $pricing->for == 'seller' ? 'selected' : '' }}>{{ __('Seller') }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="offer_name" type="text" class="form-control" name="offer_name"
                                        placeholder="{{ __('Enter offer name') }}" value="{{ $pricing->offer_name }}">
