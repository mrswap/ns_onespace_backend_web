    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Inspection Remark') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.Inspection_management.update') }}"
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="in_verificationDate" class="form-control" name="verificationDate"
                                    placeholder="Enter verificationDate">
                                <p id="editErr_verificationDate" class="mt-2 mb-0 text-danger em"></p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
