...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Inspection Properties') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Inspection Property Management') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ __('Inspection Properties') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-title d-inline-block">{{ __('Inspection Properties') }}</div>
                        </div>
                        <a href="{{ route('export.custom') }}" class="btn btn-success">
                        Export to Excel
                    </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <a class=""
                                                                    ...
                                                                    <span class="btn btn-secondary ">
                                                                        <i class="fas fa-edit"></i> {{ __('Property Assets') }}
                                                                    </span>
                                                                </a>
