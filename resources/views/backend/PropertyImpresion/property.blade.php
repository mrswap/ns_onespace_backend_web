...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Impresion Properties') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Property Impresion Management') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ __('Impresion Properties') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-title d-inline-block">{{ __('Impresion Properties') }}</div>
                        </div>
                                                <a href="{{ route('export.propertyimpression') }}" class="btn btn-success">
                        Export to Excel
                    </a>
                        <div class="col-lg-3">
                                    ...
                                    <table class="table table-striped mt-3">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">{{ __('City') }}</th>
                                                 <th scope="col">{{ __('Total Impresion') }}</th>
                                        ...
                                        <tbody>
                                            @foreach ($properties as $property)
                                                @if($property->propertyimpresions()->count()>0)
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td class="table-title">
                                                       {{$property->propertyimpresions()->count() ? $property->propertyimpresions()->count() : 0}}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                    <a class=""
                                                                    href="{{ route('admin.PropertyImpresion_management.getImpresion', $property->id) }}">
                                                                    <span class="btn btn-secondary ">
                                                                        <i class="fas fa-edit"></i> {{ __('Property Impresion') }}
                                                                    </span>
                                                                </a>
