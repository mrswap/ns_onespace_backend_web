...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBL8YzBiQkY5JCjiDUpWKvCm3ltDBXKGq8&libraries=places"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBL8YzBiQkY5JCjiDUpWKvCm3ltDBXKGq8&libraries=places&callback=initAutocomplete" async defer></script>
<script>
