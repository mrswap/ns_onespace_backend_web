                ...
                <div class="card-body">
                    <div class="card-review-wrapper custom-scrollbar">
                        <div class="card-review-box">
                            <div class="d-flex align-items-center gap-15 mb-10">
                                <div class="card-review-thumb">
                                    <img src="assets/images/agent/agent-01.png" alt="image">
                                </div>
                        ...
                        <div class="card-review-box">
                            <div class="d-flex align-items-center gap-15 mb-10">
                                <div class="card-review-thumb">
                                    <img src="assets/images/agent/agent-02.png" alt="image">
                                </div>
                                <div class="card-review-meta">
                                    <h5 class="small fw-600">Ethan Mitchell</h5>
                                    <span>Oct 09, 2023</span>
                                ...
                                <tbody>
                                    <tr class="table-custom">
                                        ...
                                        <td>
                                            <div class="property-title-box d-flex align-items-center gap-10">
                                                <div>
                                                    <h3 class="property-title underline"><a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}">Equestrian family home</a></h3>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-start gap-10">
                                                <a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}" class="action-button download"><i class="fa-regular fa-eye"></i></a>
                                                <a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}" class="action-button edit"><i class="fa-sharp fa-light fa-pen"></i></a>
                                    ...
                                    <tr class="table-custom">
                                        ...
                                        <td>
                                            <div class="property-title-box d-flex align-items-center gap-10">
                                                <div>
                                                    <h3 class="property-title underline"><a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}">Luxury
                                    ...
                                    <tr class="table-custom">
                                        ...
                                        <td>
                                            <div class="property-title-box d-flex align-items-center gap-10">
                                                <div>
                                                    <h3 class="property-title underline"><a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}">Villa
                                    ...
                                    <tr class="table-custom">
                                        ...
                                        <td>
                                            <div class="property-title-box d-flex align-items-center gap-10">
                                                <div>
                                                    <h3 class="property-title underline"><a href="{{ route('frontend.property.propertydetails', ['id' => $property->id]) }}">Sunset
                                                            Ridge Cottage</a></h3>
                                                    <div class="property-info-box mb-5">
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
