                                        ...
                                        <tr class="table-custom">
                                                    ...
                                                    <div class="property-thumb image-hover-effect-two position-relative">
                                                        ...
                                                        <div class="property-thumb-date">
                                                            <div class="bd-badge-sq theme-bg">
                                                                <div class="d-block">
                                                                    <h5 class="badge-title">{{$property->created_at->format('d')}}</h5>
                                                                    <span>{{$property->created_at->format('M')}}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="property-info-box mb-5">
                                                            <div class="bd-meta">
                                                                ...
                                                                <div class="meta-item">
                                                                    <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">{{$property->bath}} bath</span>
                                                                </div>
                                                                <div class="meta-item">
                                            ...
                                            {{-- <td>
                                                <div class="d-flex align-items-center justify-content-start gap-10">
                                                    <a href="{{ route('vendor.property_management.properties') }}" class="action-button download"><i class="fa-regular fa-eye"></i></a>
