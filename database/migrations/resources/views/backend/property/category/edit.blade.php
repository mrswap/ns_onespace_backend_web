    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Property Category') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form"
                    action="{{ route('admin.property_specification.update_types') }}" method="post"
                    ...
                    @foreach ($langs as $lan)
                        <div class="form-group {{ $lan->direction == 1 ? 'rtl text-right' : '' }}">
                            ...
                            <input type="text" id="in_{{ $lan->code }}_name" class="form-control"
                                name="{{ $lan->code }}_name" placeholder="Enter type name">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="in_status" class="form-control">
                            <option disabled>{{ __('Select Type Status') }}</option>
