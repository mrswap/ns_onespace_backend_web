                        ...
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form action="{{ route('admin.project.gallery_image_store') }}" id="my-dropzone"
                            ...
                            <form id="carForm"
                                action="{{ route('admin.project_management.update_project', $project->id) }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="vendor_id" class="form-control vendor js-example-basic-single1">
                                                ...
                                                @foreach ($vendors as $item)
                                                    <option {{ $project->vendor_id == $item->id ? 'selected' : '' }}
                                                        value="{{ $item->id }}">
                                                        {{ $item->username }} {{ $item->id == 0 ? __('(admin)') : '' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    @endphp
                                    <div class="col-lg-3">
                                        <div class="form-group agent @if (empty($project->agent_id)) d-none @endif">
...
@section('script')
    <script>
        ...
        var galleryStoreUrl = "{{ route('admin.project.gallery_image_store', ['vendor_id' => $project->vendor_id]) }}";
        var galleryRemoveUrl = "{{ route('admin.project.gallery_imagermv') }}";
        var floorPlanStoreUrl = "{{ route('admin.project.floor_plan_image_store') }}";
        var floorPlanRemoveUrl = "{{ route('admin.project.floor_plan_imagermv') }}";
        let agentUrl = "{{ route('admin.property_management.get_agent') }}";
        var galleryImagRrmvdbUrl = "{{ route('admin.project.gallery_imgdbrmv') }}";
        var floorPlanRmvdbUrl = "{{ route('admin.project.floor_plan_imgdbrmv') }}";
        var specificationRmvUrl = "{{ route('admin.project_management.specification_delete') }}";
        var galleryImages = {{ $uploadGImg }};
    </script>
