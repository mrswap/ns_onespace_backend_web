...
<main>
 ...
 <!-- Banner area start -->
        <section class="bd-banner-area banner-style-one p-relative z-index-11 top-header-banner"  data-background="https://static.ieplads.com/bmsjs/banners/99acres-hp/1366/1366-banner-1.jpg">
                            ...
                            <div class="container p-relative">
                                <div class="row justify-content-between">
                                    <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-5">
                                        <div class="banner-content p-relative wow bdFadeInLeft" data-wow-delay=".3s" data-wow-duration=".7s">
                                                    ...
                                                    <div class="tab-content" id="myTabContent1">
                                                        <div class="tab-pane fade show active" id="property-buy-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                                            <div class="banner-booking-select">
                                                                ...
                                                                <div class="location-select mb-10"> 
                                                                    <select class="location-dropdown" style="width: 100%;">
                                                                        <option value="">Location</option>
                                                                        <option value="2">Indore</option>
                                                                        <option value="3">Khargone</option>
                                                                        <option value="4">Khandwa</option>
                                                                        <option value="5">Badwani</option>
                                                                    </select>
                                                                </div>
                                                                <div class="booking-select">
                                                                    <select>
                                                                        <option value="">Price</option>
                                                                        <option value="2">₹0 - ₹25,00,000</option>
                                                                        <option value="3">₹26,00,000 - ₹50,00,000</option>
                                                                        <option value="3">₹51,00,000 - ₹75,00,000</option>
                                                                        <option value="3">₹76,00,000 - ₹1,00,00,000</option>
                                                                    </select>
                                                                </div>
                                                                <div class="booking-select">  
                                                                    <select>    
                                                                        <option value="">Real Estate Category</option>
                                                                        ...
                                                                        <option value="4">Builder Floor</option>
                                                        ...
                                                        <div class="tab-pane fade" id="property-rent-tab-pane" role="tabpanel" aria-labelledby="rent-tab" tabindex="0">
                                                            <div class="banner-booking-select">
                                                                ...
                                                                <div class="location-select mb-10"> 
                                                                    <select class="location-dropdown-second" style="width: 100%;">
                                                                        <option value="">Location</option>
                                                                        <option value="2">Indore</option>
                                                                        <option value="3">Khargone</option>
                                                                        <option value="4">Khandwa</option>
                                                                ...
                                                                <div class="booking-select">
                                                                    <select>
                                                                        <option value="">Price</option>
                                                                        <option value="2">₹0 - ₹10,000</option>
                                                                        <option value="3">₹11,000 - ₹20,000</option>
                                                                        <option value="3">₹21,000 - ₹30,000</option>
                                                                        <option value="3">₹31,000 - ₹40,000</option>
                                                                    </select>
                                                                </div>
                                                                <div class="booking-select">
                                                                    <select>
            ...
            <div class="row g-5 section-title-space align-items-center justify-content-between">
                <div class="col-xxl-7 col-xl-6 col-lg-6">
                    <div class="section-title-wrapper anim-wrapper animation-style-3">
                        <span class="section-subtitle uppercase"><i class="icon-home"></i>Featured Property Management</span>
                                                        ...
                                                        <div class="sidebar-slider">
                                                            <div class="sidebar-thumb-wrapper">
                                                                <div class="sidebar-thumb">
                                                                    <figure><img src="assets/front/v5/images/featured/featured-thumb-01.png" alt="agent-sidebar thumb not found"></figure>
                                                                </div>
                                                                <div class="badge-wrap agent-badge">
                                                                    <a href="#" class="bd-badge-blue"><img src="assets/front/v5/images/blueTick.png" alt="blue-tick" width="30px" height="30px"></a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="sidebar-widget p-0">
                                                        <div class="sidebar-slider">
                                                            <div class="sidebar-thumb-wrapper">
                                                                <div class="sidebar-thumb">
                                                                    <figure><img src="assets/front/v5/images/featured/featured-thumb-02.png" alt="agent-sidebar thumb not found"></figure>
                                                                </div>
                                                                <div class="badge-wrap agent-badge">
                                                                    <a href="#" class="bd-badge-blue"><img src="assets/front/v5/images/blueTick.png" alt="blue-tick" width="30px" height="30px"></a>
                                                                    <a href="#" class="bd-badge">For Rent</a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="sidebar-widget p-0">
                                                        <div class="sidebar-slider">
                                                            <div class="sidebar-thumb-wrapper">
                                                                <div class="sidebar-thumb">
                                                                    <figure><img src="assets/front/v5/images/featured/featured-thumb-03.png" alt="agent-sidebar thumb not found"></figure>
                                                                </div>
                                                                <div class="badge-wrap agent-badge">
                                                                    <a href="#" class="bd-badge-blue"><img src="assets/front/v5/images/blueTick.png" alt="blue-tick" width="30px" height="30px"></a>
                                                                    <a href="#" class="bd-badge">For Rent</a>
                                ...
                                <div class="featured-item style-one">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bd-meta">
                                            ...
                                            <div class="meta-item">
                                                <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">3
                                                    bath</span>
                                            </div>
                                            <div class="meta-item">
                                ...
                                <div class="featured-item style-one">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bd-meta">
                                            ...
                                            <div class="meta-item">
                                                <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">5
                                                    bath</span>
                                            </div>
                                            <div class="meta-item">
                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">1400 sqft</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="section-title-wrapper anim-wrapper section-title-space text-center animation-style-3">
                        <span class="section-subtitle uppercase"><i class="icon-home"></i>Reliable Rental Solutions</span>
            ...
            <div class="row g-5 justify-content-between justify-content-md-center">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h3 class="title">
                                <a href="services-details.html">Buy a property</a>
                            </h3>
                            <p class="description">Find your perfect property with ease. We offer a wide range of options, guiding you through every step from search to purchase, ensuring a smooth and successful buying experience.</p>
                        </div>
                        <div class="btn-inner">
                            <a class="bd-half-outline-btn" href="services-details.html"><span class="text">Learn more</span></a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Easily sell your property with our expert help. We handle listings, negotiations, and closing deals, ensuring a smooth and hassle-free process from start to finish.
                            </p>
                        </div>
                        <div class="btn-inner">
                            <a class="bd-half-outline-btn" href="services-details.html"><span class="text">Learn more</span></a>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Rent out your property quickly with our professional services. We manage everything from listing and tenant screening to finalizing agreements, ensuring a smooth and efficient process.</p>
                        </div>
                        <div class="btn-inner">
                            <a class="bd-half-outline-btn" href="services-details.html"><span class="text">Learn more</span></a>
                        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h3 class="title">
                                <a href="services-details.html">Property Management</a>
                            </h3>
                            <p class="description">Managing a property can be challenging, but our reliable property management services ensure a hassle-free experience for property owners.</p>
                        </div>
                        <div class="btn-inner">
                            <a class="bd-half-outline-btn" href="services-details.html"><span class="text">Learn more</span></a>
                        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="services-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        <span class="icon"><i class="icon-cctv-camera"></i></span>
                        <div class="content">
                            <h3 class="title">
                                <a href="services-details.html">3D Virtual View</a>
                            </h3>
                            <p class="description">Our 3D Virtual View offers a lifelike, interactive tour of your property. Let potential buyers or renters explore every detail remotely, boosting engagement and attracting more interest.
                            </p>
                        </div>
                        <div class="btn-inner">
                            <a class="bd-half-outline-btn" href="services-details.html"><span class="text">Learn more</span></a>
    ...
    <section class="bd-services-item section-space theme-bg-primary">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="section-title-wrapper anim-wrapper section-title-space text-center animation-style-3">
                        <span class="section-subtitle uppercase"><i class="icon-home"></i>Bringing You Closer to Your Dream Home</span>
                        <h2 class="section-title title-animation">Our Services</h2>
                        <p>Selling your property is easy with our expert support and tailored marketing strategies</p>
                    </div>
            ...
            <div class="row">
                <div class="col-xxl-7 col-xl-7 col-md-7">
                    ...
                    <ul class="nav nav-tabs gap-4 ourservice-tab" id="myTab1" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="apartment-type-card wow fadeIn nav-link active apartment-type-highlighted-card" id="buyProperty-tab" data-bs-toggle="tab" data-bs-target="#buyProperty-tab-pane" type="button" role="tab" aria-controls="buyProperty-tab-pane" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="apartment-type-card wow fadeIn nav-link apartment-type-highlighted-card" data-bs-toggle="tab" data-bs-target="#sellProperty-tab-pane" type="button" role="tab" aria-controls="sellProperty-tab-pane" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="apartment-type-card wow fadeIn nav-link apartment-type-highlighted-card" data-bs-toggle="tab" data-bs-target="#rentProperty-tab-pane" type="button" role="tab" aria-controls="rentProperty-tab-pane" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="apartment-type-card wow fadeIn nav-link apartment-type-highlighted-card" data-bs-toggle="tab" data-bs-target="#propertyManagement-tab-pane" type="button" role="tab" aria-controls="propertyManagement-tab-pane" aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="javascript:void(0)" class="apartment-type-card wow fadeIn nav-link apartment-type-highlighted-card" data-bs-toggle="tab" data-bs-target="#virtualView-tab-pane" type="button" role="tab" aria-controls="virtualView-tab-pane" aria-selected="false">
                                <span class="apartment-type-icon is-orange"><svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="HomepageAnonHeader_glyph-Oxxoz" fill="#fff" width="34px">
                ...
                <div class="col-xxl-5 col-xl-5 col-md-5">
                    ...
                    <div class="tab-content shadow bg-white p-5" id="myTabContent">
                        <div class="tab-pane fade active show" id="buyProperty-tab-pane" role="tabpanel" aria-labelledby="buyProperty-tab" tabindex="0">
                            <div class="about-tab-contnent">
                                <p class="section-subtitle mb-0">Your Perfect Home Awaits</p>
                                <h4 class="section-title">Find Your Dream Property</h4>
                                <p class="description pt-2">Looking to buy a property? We simplify the process, offering a wide range of listings to suit your needs. Whether you're searching for a cozy home or a great investment, our platform connects you with the best options on the market.</p>
                                <p class="description">With expert advice and personalized assistance, we guide you through every step, from property search to final purchase. Start your journey to homeownership with confidence and ease.</p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="sellProperty-tab-pane" role="tabpanel" aria-labelledby="sellProperty-tab" tabindex="0">
                            <div class="about-tab-contnent">
                                ...
                                <p class="description pt-2">Ready to sell your property? Our platform makes it simple and efficient. We provide accurate valuations, professional marketing, and access to a network of qualified buyers. From listing to closing, our team handles every detail, ensuring a smooth process from start to finish. </p>
                                <p class="description">Maximize your property’s value with our expert guidance and personalized support. Sell with confidence and ease today!
                                </p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="rentProperty-tab-pane" role="tabpanel" aria-labelledby="rentProperty-tab" tabindex="0">
                            <div class="about-tab-contnent">
                                <p class="section-subtitle mb-0">Your Ideal Home, Just a Click Away</p>
                                <h4 class="section-title">Find the Perfect Rental</h4>
                                <p class="description pt-2">Looking for a rental property? Our platform offers a diverse range of options to suit your lifestyle and budget. Whether you're searching for a cozy apartment or a spacious house, we make finding the right rental easy and stress-free.</p>
                                <p class="description">
                                    With detailed property listings, transparent pricing, and personalized support, we help you navigate the rental market with confidence. Start exploring today and find a place you’ll love to call home.
                                </p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="propertyManagement-tab-pane" role="tabpanel" aria-labelledby="propertyManagement-tab" tabindex="0">
                            <div class="about-tab-contnent">
                                ...
                                <p class="description pt-2">Managing your property doesn’t have to be a hassle. Our professional property management services ensure your investment is in good hands. From tenant screening and rent collection to maintenance and repairs, we handle every detail with care and efficiency.</p>
                                <p class="description">With our experienced team, you can trust that your property will be well-maintained, providing you peace of mind and maximizing your return on investment. Let us simplify property management for you.</p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="virtualView-tab-pane" role="tabpanel" aria-labelledby="virtualView-tab" tabindex="0">
                            <div class="about-tab-contnent">
                                ...
                                <p class="description pt-2">Discover your future property without leaving your home! Our 3D Virtual View feature allows you to explore properties in stunning detail, offering a fully immersive experience. Walk through every room, examine finishes, and visualize the space as if you were there in person.</p>
                                <p class="description">Whether you're buying or renting, our virtual tours give you the convenience of viewing properties from anywhere, anytime. Experience a new level of property exploration with us.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5 section-title-space align-items-center justify-content-between">
                <div class="col-xxl-12 col-xl-12 col-lg-12 text-center">
                    <div class="section-title-wrapper anim-wrapper animation-style-3">
                        <span class="section-subtitle uppercase"><i class="icon-home"></i>Protecting your privacy while bridging the gap.</span>
                        <h2 class="section-title title-animation">Your Privacy, Our Priority</h2>
                    </div>
                </div>
                <div class="col-md-12 text-center">
                    <div class="content">
                        <p class="description">At the initial stages of our process, we do not share landlords’ or property owners’ contact details with potential tenants or buyers. Instead, we act as an intermediary to manage inquiries, ensuring you don’t have to deal with unwanted or fake calls.</p>
                        <p class="description">This approach not only saves you from wasting time and energy but also protects your privacy. Our dedicated team will handle all negotiations and deal closures on your behalf, without charging any additional fees for this service. Let us do the hard work while you enjoy the peace of mind that your property transactions are in safe hands.
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="icon">
                                <span>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.2406 5.6167H7.92819C7.551 5.6167 7.2442 5.92357 7.2442 6.30068V9.44865C7.24412 9.82576 7.551 10.1326 7.92819 10.1326H10.2406C10.6178 10.1326 10.9246 9.82576 10.9246 9.44865V6.30068C10.9246 5.92357 10.6178 5.6167 10.2406 5.6167ZM9.786 8.99412H8.38264V6.75522H9.786V8.99412Z" fill="#D30952" />
                                        <path d="M15.316 5.6167H13.0035C12.6263 5.6167 12.3195 5.92357 12.3195 6.30068V9.44865C12.3194 9.82576 12.6263 10.1326 13.0035 10.1326H15.316C15.6932 10.1326 16 9.82576 16 9.44865V6.30068C16 5.92357 15.6932 5.6167 15.316 5.6167ZM14.8614 8.99412H13.458V6.75522H14.8614V8.99412Z" fill="black" />
                                        <path d="M27.1952 20.9156H25.0579C24.6855 20.9156 24.3826 21.2186 24.3826 21.591V24.5006C24.3826 24.873 24.6855 25.1759 25.0579 25.1759H27.1953C27.5677 25.1759 27.8706 24.8729 27.8706 24.5006V21.591C27.8706 21.2185 27.5676 20.9156 27.1952 20.9156ZM26.7321 24.0374H25.5212V22.0542H26.7321V24.0374Z" fill="#D30952" />
                                        <path d="M31.8863 20.9156H29.749C29.3766 20.9156 29.0737 21.2186 29.0737 21.591V24.5006C29.0737 24.873 29.3766 25.1759 29.749 25.1759H31.8863C32.2587 25.1759 32.5616 24.8729 32.5616 24.5006V21.591C32.5616 21.2185 32.2587 20.9156 31.8863 20.9156ZM31.4231 24.0374H30.2122V22.0542H31.4231V24.0374Z" fill="black" />
                                        <path d="M27.1953 26.8671H25.0579C24.6855 26.8671 24.3826 27.17 24.3826 27.5424V30.4521C24.3826 30.8244 24.6856 31.1273 25.0579 31.1273H27.1953C27.5677 31.1273 27.8706 30.8243 27.8706 30.4521V27.5424C27.8706 27.17 27.5676 26.8671 27.1953 26.8671ZM26.7321 29.9889H25.5211V28.0057H26.7321V29.9889Z" fill="black" />
                                        <path d="M31.8863 26.8671H29.749C29.3766 26.8671 29.0737 27.17 29.0737 27.5424V30.4521C29.0737 30.8244 29.3766 31.1273 29.749 31.1273H31.8863C32.2587 31.1273 32.5616 30.8243 32.5616 30.4521V27.5424C32.5616 27.17 32.2587 26.8671 31.8863 26.8671ZM31.4231 29.9889H30.2122V28.0057H31.4231V29.9889Z" fill="#D30952" />
                                    </svg>
                                </span>
                            </div>
                            <div class="content">
                ...
                <div class="swiper-slide">
                    <div class="filter-item">
                        <div class="filter-content">
                            ...
                            <div class="content">
                                <h6 class="title"><a href="property.html">Villa</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="filter-item">
                        <div class="filter-content">
                            ...
                            <div class="content">
                                <h6 class="title"><a href="property.html">Office</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp active" data-wow-delay=".3s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Engage directly with buyers or tenants to avoid broker fees and simplify the entire process easily.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Bypassing intermediaries allows you to save money, helping keep your costs low and maximizing value.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h3 class="title">Rental Agreement (Next day delivery)</h3>
                            <p class="description">Get a professionally prepared rental agreement delivered by the next day to ensure quick transactions.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Receive complete property management services, including maintenance and tenant support for convenience.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">List your property with ease using our simple platform designed to attract potential buyers quickly.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                    <div class="core-feature-item style-one wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            ...
                            <p class="description">Provide immersive 3D virtual tours of your property for remote buyers and renters, enhancing engagement.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
    ...
    <section class="bd-marquee-slide-area style-one position-relative ">
        <div class="container-fluid overlap-section">
            <div class="row position-relative mb-4">
                <div class="swiper text-slider swiper-width-auto text-center" data-fade-offset="50" data-sliderSpeed="90000" data-autoPlay="true">
                    <div class="swiper-wrapper marquee-slide">
                        <div class="swiper-slide">
                            <h2 class="marquee-text text-black"> Perfect match for your dream house </h2>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="thumb-wrapper">
                                        <div class="thumb">
                                            <a href="property-details.html">
                                                <figure>
                                                    <img src="assets/front/v5/images/d_hp_tenant_pref_FA.webp" alt="Image">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="collection-item style-one">
                                    <div class="thumb-wrapper">
                                        <div class="thumb">
                                            <a href="property-details.html">
                                                <figure>
                                                    <img src="assets/front/v5/images/d_hp_tenant_pref_SW.webp" alt="Image">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="collection-item style-one">
                                    <div class="thumb-wrapper">
                                        <div class="thumb">
                                            <a href="property-details.html">
                                                <figure>
                                                    <img src="assets/front/v5/images/d_hp_tenant_pref_SM.webp" alt="Image">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="collection-item style-one">
                                    <div class="thumb-wrapper">
                                        <div class="thumb">
                                            <a href="property-details.html">
                                                <figure>
                                                    <img src="assets/front/v5/images/d_hp_tenant_pref_CL.webp" alt="Image">
                                                </figure>
                                            </a>
                                        </div>
                                        <div class="content">
    ...
    <section class="pageComponent section-space theme-bg-primary">
        <div class="container">
            <div class="section-title-wrapper anim-wrapper animation-style-3 mb-30">
                <span class="section-subtitle uppercase"><i class="icon-home"></i>Choose your preferred furnishing</span>
                ...
                <div class="cc__CarouselBox">
                    <div class="row">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                            <div class="spacer10">
                                <picture>
                                    <img src="assets/front/v5/images/d_hp_furnish_1.webp" alt="99acres">
                                </picture>
                            </div>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                            <div class="spacer10">
                                <picture>
                                    <img src="assets/front/v5/images/d_hp_furnish_4.webp" alt="99acres">
                                </picture>
                            </div>
                            <div class="content mt-20">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                            <div class="spacer10">
                                <picture>
                                    <img src="assets/front/v5/images/d_hp_furnish_2.webp" alt="99acres">
                                </picture>
                            </div>
                            <div class="content mt-20">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="daily-update-content wow bdFadeInRight" data-wow-delay=".4s">
                        <div class="section-title-wrapper anim-wrapper animation-style-3 mb-30">
                            ...
                            <h2 class="section-title title-animation">Register to post your property for <span class=" bg-success free-txt">FREE</span></h2>
                        </div>
                        ...
                        <div class="bd-common-form-wrapper">
                            <a class="bd-btn btn-style btn-hover-x" type="submit"> <i class="far fa-arrow-right"></i>Post your property for FREE</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-0">
                <div class="counter-wrapper style-two">
                    <div class="counter-item wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h2 class="title"><span data-purecounter-duration="1" data-purecounter-end="1200" class="purecounter">1200+</span>+</h2>
                    ...
                    <div class="counter-item wow bdFadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h2 class="title"><span data-purecounter-duration="1" data-purecounter-end="1000" class="purecounter">1000+</span>+</h2>
                            <p class="description">Apartments sold</p>
                        </div>
                    </div>
                    <div class="apartment-counter-divider"></div>
                    <div class="counter-item wow bdFadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h2 class="title"><span data-purecounter-duration="1" data-purecounter-end="1500" class="purecounter">1500+</span>+</h2>
                            <p class="description">Award won</p>
                        </div>
                    </div>
                    <div class="apartment-counter-divider"></div>
                    <div class="counter-item wow bdFadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                        ...
                        <div class="content">
                            <h2 class="title"><span data-purecounter-duration="1" data-purecounter-end="900" class="purecounter">900+</span>+</h2>
            ...
            <div class="row gy-30 align-items-center section-title-space">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="btn-inner text-lg-end">
                        <a class="bd-btn btn-style btn-hover-x hover-white" href="property.html"><i class="fa-regular fa-arrow-right-long"></i>Discover more</a>
                    </div>
                </div>
            </div>
            <div class="row g-5 wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            ...
                            <h3 class="title"><a href="property-details.html">Rajwada</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            ...
                            <h3 class="title"><a href="property-details.html">Vijay Nagar</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            <span class="info">04 properties</span>
                            <h3 class="title"><a href="property-details.html">Palasia</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            ...
                            <h3 class="title"><a href="property-details.html">AB Road</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            ...
                            <h3 class="title"><a href="property-details.html">LIG Colony</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                    <div class="neighbour-area-item">
                        ...
                        <div class="content">
                            ...
                            <h3 class="title"><a href="property-details.html">Vikramaditya</a></h3>
                        </div>
                        <a class="link" href="property-details.html"><i class="fa-regular fa-arrow-up-right"></i></a>
                    </div>
                </div>
    ...
    <div class="bd-video-area style-one position-relative jarallax">
        <div class="video-bg-thumb include-bg jarallax-img" data-background="assets/front/v5/images/bg/video-bg-01.png">
        </div>
        <div class="container">
            <div class="row justify-content-center">
            ...
            <div class="row">
                <div class="col-xxl-5 col-xl-5 col-lg-6">
                    <div class="section-title-wrapper anim-wrapper animation-style-3 section-title-space">
                        <span class="section-subtitle uppercase"><i class="icon-home"></i>{{ $testimonialSecInfo->title }}</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".3s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Living space</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".4s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Parking area</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".5s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Swimming pools</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".6s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Security feature</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".7s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Office spaces</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".8s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Clinics center</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay=".9s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">kids playzone</a>
                        </h3>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="benefits-item style-one wow fadeIn" data-wow-delay="1s">
                        ...
                        <h3 class="benefits-title">
                            <a href="property-details.html">Educational area</a>
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center gy-30">
                    ...
                    <div class="contact-info wow bdFadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                        ...
                        <div class="item">
                            <div class="content">
                                ...
                                <span class="info"><a href="https://html.bdevs.net/cdn-cgi/l/email-protection#ea988f8b8686859daa878b8386c4898587"><span class="__cf_email__" data-cfemail="7f0d1a1e131310083f121e1613511c1012">[email&#160;protected]</span></a></span>
                            </div>
                            <div class="icon">
                ...
                <div class="col-xxl-8 col-xl-7 col-lg-7">
                    <div class="contact-wrapper style-one wow bdFadeInRight" data-wow-delay=".4s" data-wow-duration="1s">
                        <div class="section-title-wrapper anim-wrapper animation-style-3 mb-30">
                            <span class="section-subtitle uppercase">
                                <i class="icon-home"></i>
                                Contact Us
