...
<meta property="og:image" content="{{ asset('{{asset("assets/front/v5<meta property="og:image" content="{{ asset('{{asset("assets/front/v5/front/v5/img/project/featured/' . $project->featured_image) }}">/front/v5/img/project/featured/' . $project->featured_image) }}">
                    ...
                    <div class="col-xl-10">
                        <div class="bd-breadcrumb">
                            <div class="bd-breadcrumb-content text-center">
                                <h1 class="bd-breadcrumb-title">Property Management</h1>
            ...
            <div class="row g-5">
                <div class=" col-xxl-6 col-xl-6 col-lg-6 order-1 order-lg-0 wow bdFadeInLeft" data-wow-delay=".3s">
                    <div class="section-title-wrapper anim-wrapper animation-style-3 mb-20">
                        ...
                        <h2 class="section-title title-animation">Expert Property Management for Your Real Estate Investments</h2>
                    </div>

                    <div class="content">
                        <p class="description">
                            Maximize your property’s potential with our full-suite property management services. Whether it's residential, commercial, or industrial real estate, we take the hassle out of managing your property while ensuring it runs smoothly and generates consistent returns.
                        </p>
                    </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 order-0 order-lg-1">
                    <div class="thumb">
                        ...
                        <figure> <img src="{{asset("assets/front/v5/images/property-management.jpeg" ) }} "alt="about thumb not found">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    <section class="bd-pricing-area section-space" id="pricingPlan">
        <div class="container">
            ...
            <div class="row g-5 wow fadeInUp" data-wow-delay=".3s">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="pricing-wrapper pricing-item">
                        <div class="pricing-content">
                            ...
                            <p class="pricing-description">An introductory section that provides an overview of the
                                document</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="pricing-wrapper pricing-item active">
                        <div class="pricing-content">
                        ...
                        <div class="pricing-btn">
                            <a class="bd-btn btn-style btn-hover-x w-100" href="booking.html">Book Now</a>
                        </div>
                        <div class="pricing-feature">
                            <ul class="pricing-list">
                                <li>
