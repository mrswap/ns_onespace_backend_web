...
<main>
    ...
    <section class="bd-breadcrumb-area p-relative fix">
        ...
        <div class="google-map property-management-map">
        ...
        <div class="bd-breadcrumb-wrapper property-management-breadcrumb">
            <div class="container">
                        ...
                        <div class="property-widget">
                            ...
                            <div class="bd-property-widget-content">
                                <div class="bd-property-widget-categories">
                                    <ul>
                                        <li>
                                            <a href="#">Buying <span>10</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Renting <span>18</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Market Update <span>22</span></a>
                                        </li>
                                        <li>
                                            <a href="#">House Construction <span>17</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Selling <span>22</span></a>
                                        </li>
                                        <li>
                                            <a href="#">Investment<span>14</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="product-widget-content">
                                <div class="property-widget-product">
                                    <div class="property-widget-product-item">
                                        <div class="property-widget-product-thumb">
                                            <a href="property-details.html">
                                                <img src="{{asset("assets/front/v5/images/blog/sidebar/blog-sm-01.png")}}" alt />
                                            </a>
                                        </div>
                                    ...
                                    <div class="property-widget-product-item">
                                        <div class="property-widget-product-thumb">
                                            <a href="property-details.html">
                                                <img src="{{asset("assets/front/v5/images/blog/sidebar/blog-sm-02.png")}}" alt />
                                            </a>
                                        </div>
                                    ...
                                    <div class="property-widget-product-item">
                                        <div class="property-widget-product-thumb">
                                            <a href="property-details.html">
                                                <img src="{{asset("assets/front/v5/images/blog/sidebar/blog-sm-03.png")}}" alt />
                                            </a>
                                        </div>
                                        <div class="property-widget-product-content">
                                            <div class="property-widget-product-rating-wrapper">
                                    ...
                                    <div class="property-widget-product-item">
                                        <div class="property-widget-product-thumb">
                                            <a href="property-details.html">
                                                <img src="{{asset("assets/front/v5/images/blog/sidebar/blog-sm-04.png")}}" alt />
                                            </a>
                                        </div>
                                        <div class="property-widget-product-content">
                                            <div class="property-widget-product-rating-wrapper">
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <div class="featured-item style-three wow bdFadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                                ...
                                                <div class="content">
                                                    <h3 class="title"><a href="property-details.html">{{$property->title}}</a></h3>
                                                    <span class="info">{{$property->address}}</span>
                                                    <div class="bd-meta">
                                                        <div class="meta-item">
                                                            <span class="icon"><i class="fa-regular fa-bed-front"></i></span><span class="title">{{$property->beds}}
                                                                bad</span>
                                                        </div>
                                                        <div class="meta-item">
                                                ...
                                                <div class="bd-meta-profile">
                                                    <div class="bd-profile-info">
                                                        <div class="thumb">
                                                            <a href="{{ route("agent-detail",$property->agent_id) }}">
                                                                <img src="{{asset("assets/front/v5/images/user/user-thumb-01.png")
                                                                }} " alt=" Profile image not found">
                                                            </a>
                                                        </div>
                                                        <h6 class="profile-title"><span>By </span><a href="{{ route("agent-detail",$property->agent_id) }}">{{$property->agent_name;}} </a>
                                                        </h6>
                                                    </div>
                                                    <div class="profile-arrow">
                                                        <a class="link" href="{{ route("agent-detail",$property->agent_id) }}"><span><i class="fa-regular fa-arrow-right-long"></i></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @endforeach
                                        <div class="col-xl-6 col-md-6">
                                            <div class="featured-item style-three wow bdFadeInUp" data-wow-delay="1s" data-wow-duration="1s">
                                                <div class="thumb-wrapper">
                                                    <div class="badge-wrap">
                                                        <span class="bd-badge">Featured</span>
                                                    </div>
                                                ...
                                                <div class="content">
                                                    <h3 class="title">
                                                        <a href="property-details.html">Most inspiring interior</a>
                                                    </h3>
                                                    <span class="info">California, CA, USA</span>
                                                    <div class="bd-meta">
                                                        <div class="meta-item">
                                                            <span class="icon"><i class="fa-regular fa-bed-front"></i></span><span class="title">9 bad</span>
                                                        </div>
                                                        <div class="meta-item">
                                                            <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">5 bath</span>
                                                        </div>
                                                        <div class="meta-item">
                                                            <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">3000 sqft</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bd-meta-profile">
                                                    <div class="bd-profile-info">
                                                        <div class="thumb">
                                                            <a href="{{ route("agent-detail",$property->agent_id) }}">
                                                                <img src="{{asset("assets/front/v5/images/user/user-thumb-03.png")}}" alt="Profile image not found" />
                                                            </a>
                                                        </div>
                                                        <h6 class="profile-title">
                                                            <span>By </span><a href="{{ route("agent-detail",$property->agent_id) }}">Tomas D.</a>
                                                        </h6>
                                                    </div>
                                                    <div class="profile-arrow">
                                                        <a class="link" href="{{ route("agent-detail",$property->agent_id) }}"><span><i class="fa-regular fa-arrow-right-long"></i></span></a>
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-08.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Equestrian family home</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                        ...
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
                                                                <div class="thumb">
                                                                    <a href="{{ route("agent-detail",$property->agent_id) }}">
                                                                        <img src="{{asset("assets/front/v5/images/user/user-thumb-01.png")}}" alt="Profile image not found" />
                                                                    </a>
                                                                </div>
                                                                <h6 class="profile-title">
                                                                    <span>By </span><a href="{{ route("agent-detail",$property->agent_id) }}">Tomas D.</a>
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-09.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Tranquil Oaks</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-bed-front"></i></span><span class="title">5 bad</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">2 bath</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">1500 sqft</span>
                                                            </div>
                                                        </div>
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
                                                                <div class="thumb">
                                                                    <a href="{{ route("agent-detail",$property->agent_id) }}">
                                                                        <img src="{{asset("assets/front/v5/images/user/user-thumb-02.png")}}" alt="Profile image not found" />
                                                                    </a>
                                                                </div>
                                                                <h6 class="profile-title">
                                                                    <span>By </span><a href="{{ route("agent-detail",$property->agent_id) }}">Tomas D.</a>
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-10.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Whispering Pines Retreat</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                            ...
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">1600 sqft</span>
                                                            </div>
                                                        </div>
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-11.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Meadow view Manor</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-bed-front"></i></span><span class="title">7 bad</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">3 bath</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">1800 sqft</span>
                                                            </div>
                                                        </div>
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-12.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Sunset Ridge Cottage</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-bed-front"></i></span><span class="title">8 bad</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-duotone fa-shower"></i></span><span class="title">5 bath</span>
                                                            </div>
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">2000 sqft</span>
                                                            </div>
                                                        </div>
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
                                                ...
                                                <div class="featured-item style-four">
                                                    <div class="thumb-wrapper">
                                                        ...
                                                        <div class="thumb">
                                                            <a href="property-details.html">
                                                                <figure>
                                                                    <img src="{{asset("assets/front/v5/images/featured/featured-thumb-14.png")}}" alt="image" />
                                                                </figure>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="title">
                                                            <a href="property-details.html">Decorate room state</a>
                                                        </h3>
                                                        <span class="info">California, CA, USA</span>
                                                        <div class="bd-meta">
                                                            <div class="meta-item">
                                                            ...
                                                            <div class="meta-item">
                                                                <span class="icon"><i class="fa-regular fa-arrows-maximize"></i></span><span class="title">2600 sqft</span>
                                                            </div>
                                                        </div>
                                                        <div class="bd-meta-profile">
                                                            <div class="bd-profile-info">
