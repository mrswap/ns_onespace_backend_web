                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            ...
                            <form id="carForm" action="{{ route('agent.update_profile') }}" method="post">
                                @csrf
                                <h2>{{ __('Details') }}</h2>
                                <hr>
                                <div class="row">
                                        ...
                                        <div id="accordion" class="mt-5">
                                            @foreach ($languages as $language)
                                                <div class="version">
                                                    ...
                                                    @php
                                                        $agent_info = App\Models\AgentInfo::where('agent_id', $agent->id)
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="{{ $language->code }}_address" class="form-control" placeholder="Enter Address">{{ !empty($agent_info) ? $agent_info->address : '' }}</textarea>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="{{ $language->code }}_details" class="form-control" rows="5" placeholder="Enter Details">{{ !empty($agent_info) ? $agent_info->details : '' }}</textarea>
